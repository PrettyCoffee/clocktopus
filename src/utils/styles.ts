...
export const colored = cva("", {
  ...
  compoundVariants: [
    ...
    { color: "amber", type: "text", className: "text-category-amber" },
    ...
    { color: "emerald", type: "text", className: "text-category-emerald" },
    { color: "teal", type: "text", className: "text-category-teal" },
    { color: "cyan", type: "text", className: "text-category-cyan" },
    { color: "sky", type: "text", className: "text-category-sky" },
    ...
    { color: "purple", type: "text", className: "text-category-purple" },
    ...
    { color: "amber", type: "bg", className: "bg-category-amber" },
    ...
    { color: "emerald", type: "bg", className: "bg-category-emerald" },
    { color: "teal", type: "bg", className: "bg-category-teal" },
    { color: "cyan", type: "bg", className: "bg-category-cyan" },
    { color: "sky", type: "bg", className: "bg-category-sky" },
    ...
    { color: "purple", type: "bg", className: "bg-category-purple" },
